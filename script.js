...
img1.src =
  "https://option.nyc3.digitaloceanspaces.com/files/17769/image-swatches-1_1_1644641840688-1644652024.jpg";

document.getElementById("image-swatches-1_1_1644641840688").appendChild(img1);
...
img2.src =
  "https://option.nyc3.digitaloceanspaces.com/files/17769/image-swatches-2_1_1644641840688-1644652352.jpg";

document.getElementById("image-swatches-2_1_1644641840688").appendChild(img2);

let img3 = document.createElement("img");
img3.setAttribute("id", "img3");
img3.style.cursor = "pointer";
img3.src =
  "https://option.nyc3.digitaloceanspaces.com/files/17769/image-swatches-3_1_1644641840688-1644652455.jpg";

document.getElementById("image-swatches-3_1_1644641840688").appendChild(img3);

// document.querySelectorAll("label span, legend span").style.color = "white";
...
const elements = document.getElementsByClassName("gpo-tooltip");

while (elements.length > 0) elements[0].remove();

document.querySelectorAll(".image-swatches").style.marginTop = "%";
